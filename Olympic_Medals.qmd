...
🥇 In a first step, Germany hopes to stop the downward trend in the medal table.
...
While the overall medal target seems far away, with the number of gold medals they've already won, Germany is well on their way to matching their last position.
